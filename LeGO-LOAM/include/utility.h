...
extern const float ang_res_y = 2.0;             //垂直角度分辨率
extern const float ang_bottom = 15.0+0.1;     //计算垂直角度分辨率用 
extern const int groundScanInd = 7;          //地面线束的索引等于7（7以下的线束都是负值)
...
extern const bool loopClosureEnableFlag = true;                        //true开启闭环检测，false不开启闭环检测
...
extern const float sensorMinimumRange = 1.0;        //传感器最小距离
